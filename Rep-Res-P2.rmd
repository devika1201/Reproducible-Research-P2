---
title: Weather events that are most harmful to public health and have greatest economic
  consequences
output:
...
Storms and other severe weather events have huge impact on public health and create economic problems for municipalities and their inhabitants. Some of the severe events can cause injuries, property damage and even lead to death. 
This analysis addresses which types of events are most harmful with respect to population health and which have the greatest economic consequences.

# Data Processing

I am exploring the NOAA storm database which tracks characteristics of major storms and weather events in the United States. This dataset comes from the Internet. 


Download file from the Internet:
```{r get-data, cache = TRUE}
filename <- 'C:/Users/Deep/Documents/StormData.csv.bz2'
...
Read file in table format
```{r, echo=TRUE, cache=TRUE}
StormData <- read.csv(bzfile("C:/Users/Deep/Documents/StormData.csv.bz2"),sep = ",",header=TRUE)
```
